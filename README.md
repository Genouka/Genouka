...
- [QiuUTMTv4](https://github.com/QiumingOrg/QiuUTMTv4)（在Android上运行的Undertale Mod Tool GUI客户端）
- [AGL2D游戏引擎](https://github.com/Genouka/AGL2D)（基于LOVE2d和Androlua的游戏引擎）

🌸我开发的其他项目
- [秋冥OCR](https://github.com/Genouka/FallOCR)（基于MLKit的安卓OCR程序）
- [Ruffle运行Flash内容油猴脚本](https://github.com/Genouka/FlashPatcherJS)
